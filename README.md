...
**Q：中文文献识别不准？**
中文标题识别参考[茉莉花（Jasminum）的处理思路](https://github.com/l0o0/jasminum/blob/b63a6a1e0ac4ce25fcd0c9200ec647b063ce02c0/src/utils/pdfParser.ts)，在本插件中独立实现：合并同一行文字，利用字号和位置识别标题，处理网络首发封面和学位论文题目。识别结果需在导入预览中核对；扫描图片PDF仍需先做OCR。PDF生成日期不会作为论文发表日期。
